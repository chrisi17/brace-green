"""A2A conformance tests for BraceGreen agents.

Based on the official green-agent-template:
https://github.com/RDI-Foundation/green-agent-template/blob/main/tests/test_agent.py
"""
...
async def send_text_message(text: str, url: str, context_id: str | None = None, streaming: bool = False):
    """Send a text message to an A2A agent and return all events."""
